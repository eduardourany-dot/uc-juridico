...
| v6.22 | ✅ em produção | **Financeiro A.4** — Recorrências mensais + Balancete por mês/ano + exportações CSV |
| **v6.23** | **próxima** | Financeiro A.5 — push/email de parcela vencendo (reusa FCM Sprint 3) |
